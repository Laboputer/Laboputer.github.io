---
layout: post
title:  "별도 설치 없이 머신러닝(python) 개발환경 사용하기"
subtitle:   "colab"
...
그리고 Kernel 상태를 통해 코드가 실행가능 한지, 또는 메모리 상황은 어떠한지 확인하실 수 있습니다.

### 2. GPU를 사용하고 싶습니다.

```
Runtime - Change runtime type 에서 하드웨어 가속기를 변경할 수 있습니다.
```
...
자세한 내용은 단축키 정보는 아래에서 확인하세요.
```
Tools - Keyboard shortcuts 메뉴에서 확인할 수 있습니다. (단축키 Ctrl+M H)
```
...
Colab도 테마를 변경할 수 있습니다.
```
Tools - Settings 메뉴에서 확인할 수 있습니다.
```
